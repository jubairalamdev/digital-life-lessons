...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full bg-white dark:bg-zinc-950 flex flex-col justify-center items-center px-4 relative selection:bg-green-500/30 overflow-hidden">
      ...
      <div className="text-center z-10 max-w-md mx-auto">
        ...
        <div className="relative inline-block select-none animate-pulse">
          <h1 className="text-[12rem] font-black tracking-tighter text-zinc-900/40 border-zinc-200 dark:border-zinc-800 leading-none">
            404
          </h1>
        ...
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mt-4 tracking-tight">
          This Lesson is <span className="text-green-400">Missing</span>
        </h2>
        
        <p className="text-zinc-400 dark:text-zinc-500 text-sm mt-3 font-light leading-relaxed">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button 
            ...
            className="w-full sm:w-auto bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 font-medium px-8 py-3 h-12 rounded-xl transition-all text-sm"
          >
            Previous Page
          </button>
        </div>
